const net = require("net");
 ...
 if (process.argv.length < 7){console.log('example: node tls-arz.js <host> <time> <rps> <threads> <proxyfile>'); process.exit();}
 const headers = {};
...
`);
        console.log("𝗦𝘂𝗰𝗰𝗲𝘀𝗳𝘂𝗹𝗹𝘆 𝗦𝗮𝗻𝗱𝗶𝗻𝗴 𝗔𝘁𝘁𝗮𝗰𝗸 𝗨𝗽𝗴𝗿𝗮𝗱𝗲 𝗕𝘆 @𝗡𝗜𝗫𝗢𝗡 𝗖𝟮\n");
